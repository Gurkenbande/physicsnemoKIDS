...
def main(json_path='../deep_learning/options/msrresnet0gan_gcn_config.json'):
        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                for test_data in test_loader:
                    ...
                    save_img_path_p = os.path.join(img_dir, 'p_{:s}_{:d}.png'.format(img_name, current_step))
                    util.imsave(E_img * 140.0 * 255, save_img_path)
                    #util.imsave_plt(E_img * 140.0, save_img_path_p)
                   ...
                   # -----------------------
                    ...
                    logger.info('{:->4d}--> {:>10s} | {:<4.2f}dB | {:<7.5f} | {:<7.5f} '.format(idx, image_name_ext, current_psnr, current_mae*100, current_ssim))
